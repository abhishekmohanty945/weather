...
var WeatherProvider = /** @class */ (function () {
    function WeatherProvider(http) {
        this.http = http;
        this.apiKey = '1fbd74c6da744b918fc115322182907';
...
var TabsPage = /** @class */ (function () {
    ...
    TabsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"E:\Projects\WeatherApp\src\pages\tabs\tabs.html"*/'<ion-tabs>\n  <ion-tab [root]="tab1Root" tabTitle="Home" tabIcon="home"></ion-tab>\n  <ion-tab [root]="tab2Root" tabTitle="About" tabIcon="information-circle"></ion-tab>\n  <ion-tab [root]="tab3Root" tabTitle="Settings" tabIcon="cog"></ion-tab>\n</ion-tabs>\n'/*ion-inline-end:"E:\Projects\WeatherApp\src\pages\tabs\tabs.html"*/
        }),
...
var AboutPage = /** @class */ (function () {
    ...
    AboutPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-about',template:/*ion-inline-start:"E:\Projects\WeatherApp\src\pages\about\about.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      About\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  <ion-grid>\n    <ion-row>\n      <ion-col width-100>\n        <ion-list>\n          <ion-item>\n            <strong>App Name:</strong> WeatherApp\n          </ion-item>\n          <ion-item>\n            <strong>Version:</strong> 1.0.0\n          </ion-item>\n          <ion-item>\n            <strong>Description:</strong> Simple weather app.\n          </ion-item>\n        </ion-list>\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n</ion-content>\n'/*ion-inline-end:"E:\Projects\WeatherApp\src\pages\about\about.html"*/
        }),
...
var SettingsPage = /** @class */ (function () {
    ...
    SettingsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-settings',template:/*ion-inline-start:"E:\Projects\WeatherApp\src\pages\settings\settings.html"*/'<!--\n  Generated template for the SettingsPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>settings</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n  <ion-grid>\n    <ion-row>\n      <ion-col>\n        <ion-list>\n          <form (ngSubmit)="saveForm()">\n            <ion-item>\n              <ion-label>\n                City\n              </ion-label>\n              <ion-input [(ngModel)]="city" name="city" type="text" ></ion-input>\n            </ion-item>\n            <button ion-button type="submit" block ion-button color="danger">Save Changes</button>\n          </form>\n        </ion-list>\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n</ion-content>\n'/*ion-inline-end:"E:\Projects\WeatherApp\src\pages\settings\settings.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* NavController */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__providers_weather_weather__ = __webpack_require__(153);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"E:\Projects\WeatherApp\src\app\app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"E:\Projects\WeatherApp\src\app\app.html"*/
        }),
...
var HomePage = /** @class */ (function () {
    ...
    HomePage.prototype.ionViewWillEnter = function () {
        ...
        this.storage.get('location').then(function (val) {
            ...
            _this.weatherProvider.getWeather(_this.location.city).subscribe(function (data) {
                console.log(data);
                _this.loc = data.json().location;
                _this.currentWeather = data.json().current;
            });
        });
    };
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"E:\Projects\WeatherApp\src\pages\home\home.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>Weather</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding class="home">\n \n    <ion-grid *ngIf=\'loc\'>\n    <ion-row>\n      <ion-col width-50 offset-25>\n        <h2 class="location" ion-text color="secondary">{{loc.name}}  </h2>\n        <div class="icon"> <img src="{{currentWeather.condition.icon}}" alt=""> </div>\n        <h2 class="description" ion-text color="secondary">{{currentWeather.condition.text}}</h2>\n        <h2 class="temp" ion-text color="secondary" >{{currentWeather.temp_c}}&deg;</h2>     \n      </ion-col>\n    </ion-row>\n    <ion-row>\n      <ion-col width-100>\n        <ion-list class="list">\n            <ion-item>\n                <strong>wind_kph: </strong> {{currentWeather.wind_kph}}\n              </ion-item>\n          <ion-item>\n            <strong>Humidity: </strong> {{currentWeather.humidity}}\n          </ion-item>\n        </ion-list>\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n\n</ion-content>\n'/*ion-inline-end:"E:\Projects\WeatherApp\src\pages\home\home.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* NavController */],
